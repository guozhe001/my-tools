 ...
 * @author guozhe
 */
public class PhoneNumberOverrideHashCode {
    ...
    public PhoneNumberOverrideHashCode(int areaCode, int prefix, int lineNumber) {
    ...
    public boolean equals(Object o) {
        ...
        PhoneNumberOverrideHashCode that = (PhoneNumberOverrideHashCode) o;
